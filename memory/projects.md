...
| Alcanthia mobile game | Active side project and serious candidate for larger opportunity; DAU approx. 200, ROAS approx. 150%, D7 retention approx. 10-15% | Run a roughly 3-month validation push toward stable 18-22% D7 retention while preserving payment quality and ROAS. See `memory/alcanthia.md`. | Above BEP but not yet profitable enough to justify shifting heavy company weight onto it. If D7 remains 10-15% after serious experiments, reduce to maintenance and test a smaller next-game hypothesis. | 2026-06-15 |
